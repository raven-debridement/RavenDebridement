...
class ARImageDetector(ImageDetector):
      ...
      def __init__(self, normal=None):
            ...
            self.homePoint = tfx.point([-.073,-.016,-.104],frame=Constants.Frames.Link0).msg.PointStamped()
            ...
            self.receptaclePoint = tfx.point([-.073,-.016,-.124],frame=Constants.Frames.Link0).msg.PointStamped()
