...
class ARImageDetector(ImageDetector):
      ...
      def __init__(self, normal=None):
            ...
            self.homePoint = tfx.point([-.098,.004,-.085],frame=Constants.Frames.Link0).msg.PointStamped()
            ...
            self.receptaclePoint = tfx.point([-.098,.004,-.095],frame=Constants.Frames.Link0).msg.PointStamped()
