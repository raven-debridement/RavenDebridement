...
class ARImageDetector(ImageDetector):
      ...
      def __init__(self, normal=None):
            ...
            self.homePoint = tfx.point([-.098,.004,-.100],frame=Constants.Frames.Link0).msg.PointStamped()
            ...
            self.receptaclePoint = tfx.point([-.098, .004, -.150],frame=Constants.Frames.Link0).msg.PointStamped()
